...
- **ClickUp Integration** — OAuth authentication, workspace/space/folder/list browsing, task search by ID or name, task preview with subtasks and comments, create worktrees from tasks, investigate tasks with AI
